...
const WEB3FORMS_KEY = 'bbb7b563-0d90-44a2-a168-062b9bd7d027';
...
const contactInfo = [
  {
    ...
    label: 'Email',
    value: 'arihantshukla24@gmail.com',
    href: 'mailto:arihantshukla24@gmail.com',
  },
  {
    id: 'location',
    icon: (
...
const socials = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/arihant-shukla24',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
